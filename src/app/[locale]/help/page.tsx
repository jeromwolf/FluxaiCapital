...
const faqData: FAQItem[] = [
  {
    ...
    answer:
      'FLUX AI Capital은 AI 기반의 전략적 자산관리 플랫폼입니다. 개인 투자자들이 전문가 수준의 포트폴리오 관리, 백테스팅, 리스크 분석 등을 활용할 수 있도록 도와드립니다.',
  },
  {
    id: '2',
    category: '시작하기',
    question: '어떻게 시작하나요?',
    answer:
      '회원가입 후 첫 포트폴리오를 생성하시면 됩니다. 포트폴리오 메뉴에서 "새 포트폴리오" 버튼을 클릭하고, 투자 목적에 맞는 이름과 설명을 입력해주세요.',
  },
  {
    id: '3',
    category: '포트폴리오',
    ...
    answer:
      '기본 계정은 최대 5개의 포트폴리오를 생성할 수 있습니다. 프리미엄 계정은 무제한으로 포트폴리오를 생성할 수 있습니다.',
  },
  {
    id: '4',
    category: '포트폴리오',
    ...
    answer:
      '포트폴리오 상세 페이지에서 "거래 추가" 버튼을 클릭하여 매수, 매도, 입금, 출금 등의 거래를 입력할 수 있습니다. CSV 파일로 일괄 업로드도 가능합니다.',
  },
  {
    id: '5',
    category: '백테스팅',
    ...
    answer:
      '백테스팅은 과거 데이터를 바탕으로 투자 전략의 성과를 시뮬레이션하는 기능입니다. 다양한 전략을 테스트해보고 최적의 투자 방법을 찾을 수 있습니다.',
  },
  {
    id: '6',
    category: '백테스팅',
    ...
    answer:
      '모멘텀, 평균회귀, 밸류 투자 등 다양한 전략을 제공합니다. 또한 사용자가 직접 커스텀 전략을 만들어 테스트할 수도 있습니다.',
  },
  {
    id: '7',
    category: '요금',
    ...
    answer:
      '기본 기능은 무료로 이용 가능합니다. 고급 분석, 실시간 알림, API 연동 등의 프리미엄 기능은 월 29,900원에 이용하실 수 있습니다.',
  },
  {
    id: '8',
    category: '보안',
    ...
    answer:
      '모든 데이터는 암호화되어 저장되며, 2단계 인증을 통해 계정을 보호합니다. 또한 정기적인 보안 감사를 실시하여 안전성을 보장합니다.',
  },
];
...
export default function HelpPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">도움말 센터</h1>
            ...
            <ResponsiveCard key={item.id} className="p-4">
              ...
              >
                <div className="flex-1">
                  ...
                  <h3 className="font-medium text-gray-900 dark:text-gray-100">{item.question}</h3>
                </div>
              ...
              {expandedItems.includes(item.id) && (
                <p className="mt-3 text-gray-600 dark:text-gray-400 pl-0">{item.answer}</p>
              )}
            </ResponsiveCard>
          ))
        )}
