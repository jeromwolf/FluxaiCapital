  ...
  if (variant === 'detailed') {
    return (
      <div className={cn(
        ...
        reconnecting && 'bg-yellow-50 dark:bg-yellow-900/20 border-yellow-200 dark:border-yellow-800',
        !connected && !reconnecting && 'bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800',
        className
      )}>
  ...
  return (
    <div className={cn('flex items-center space-x-2', className)}>
      <div className={cn(
        ...
        reconnecting && 'bg-yellow-100 dark:bg-yellow-900/20 text-yellow-700 dark:text-yellow-400',
        !connected && !reconnecting && 'bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-400'
      )}>
        {connected ? (
          <>
