        ...
        {marketSentiment && (
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className={`text-sm font-medium ${getSentimentColor(marketSentiment.overall.score)}`}>
                {marketSentiment.overall.score > 0 ? '+' : ''}{marketSentiment.overall.score.toFixed(1)}
              </span>
            </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className={`text-sm ${getSentimentColor(data.sentiment.score)}`}>
                      {data.sentiment.score > 0 ? '+' : ''}{data.sentiment.score.toFixed(0)}
                    </span>
